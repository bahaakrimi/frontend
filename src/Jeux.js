  ...
  return (
    <>
      ...
      <div class="fashion_section">
        <div id="sport_main_slider" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <div class="container">
          ...
          <a class="carousel-control-prev" href="#sport_main_slider" role="button" data-slide="prev">
            <i class="fa fa-angle-right"></i>
          </a>
          <a class="carousel-control-next" href="#sport_main_slider" role="button" data-slide="next">
            <i class="fa fa-angle-left"></i>
          </a>
        </div>
      </div>

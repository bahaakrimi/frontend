  ...
  return (
    <div style={styles.pageContainer}>
      ...
      <div style={styles.storeHeader}>
        Bijouterie Traditionnelle - 0522041818 pour commander
      </div>
      ...
      <div style={styles.productCard}>
        ...
        <div style={styles.imageSection}>
          <img 
            src="./assets/images/neklesh-img.png" 
            alt="Kangan"
            style={styles.productImage}
          />
          <div>
            <h2 style={styles.productTitle}>Kangan</h2>
            <p style={styles.productSubtitle}>(Pièce traditionnelle en or 24 carats)</p>
          </div>
        </div>
        ...
        <div style={styles.priceSection}>
          <span style={styles.currentPrice}>500,000 DT</span>
          <span style={styles.originalPrice}>750,000 DT</span>
        ...
        {showDetails && (
          <div style={styles.detailsSection}>
            <h3 style={styles.detailsTitle}>Détails du produit</h3>
            
            <div style={styles.specsGrid}>
              <div style={styles.specItem}>
                <strong>Type:</strong> Bracelet traditionnel
              </div>
              <div style={styles.specItem}>
                <strong>Pureté:</strong> Or 24 carats (99.9%)
              </div>
              <div style={styles.specItem}>
                <strong>Poids total:</strong> 15 grammes
              </div>
              <div style={styles.specItem}>
                <strong>Taille:</strong> Ajustable
              </div>
              <div style={styles.specItem}>
                <strong>Finition:</strong> Poli miroir
              </div>
              <div style={styles.specItem}>
                <strong>Origine:</strong> Fabriqué en Inde
              </div>
              <div style={styles.specItem}>
                <strong>Garantie:</strong> 1 an
              </div>
              <div style={styles.specItem}>
                <strong>Certificat:</strong> Authenticité incluse
              </div>
            </div>

            <div style={styles.promotionsSection}>
              <h4>INCLUS AVEC VOTRE ACHAT</h4>
              <ul style={styles.promotionsList}>
                <li>Écrin de luxe offert</li>
                <li>Certificat d'authenticité</li>
                <li>Service de gravure gratuit</li>
              </ul>
            </div>
          </div>
        )}
...
export default KanganProductPage;